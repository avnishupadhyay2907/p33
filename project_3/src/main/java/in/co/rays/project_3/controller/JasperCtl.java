	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JasperReport jasperReport = JasperCompileManager
					.compileReport("C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\p33@tmp\\pro.jrxml");
			...
			/* / Filling data into the report / */ JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport,
					map, conn);

			/* / Export Jasper report / */ byte[] pdf = JasperExportManager.exportReportToPdf(jasperPrint);
